...
void func_507(bool bParam0)
{
  if (bParam0)
  {
    if (iLocal_476 == 0)
    {
      iLocal_476 = PED::ADD_SCENARIO_BLOCKING_AREA(-1196.229f, -575.1415f, 0.879524f, -1035.999f, -474.7514f, 68.87952f, 0, 1, 1, 1);
    }
  ...
  else
  {
    if (iLocal_476 != 0)
    {
      PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_476, 0);
      iLocal_476 = 0;
    }
    if (iLocal_477 != 0)
    {
      PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_477, 0);
      iLocal_477 = 0;
    }
