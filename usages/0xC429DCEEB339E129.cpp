// am_casino_peds.ysc @ L296439
void func_3653(int iParam0, int iParam1, int iParam2, float fParam3, int iParam4)
{
  float fVar0;
  float fVar1;
  ...
  {
    if (VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0) && !PED::IS_PED_DEAD_OR_DYING(*iParam0, 1))
    {
